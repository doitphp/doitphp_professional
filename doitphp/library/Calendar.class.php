 ...
 * @version $Id: Calendar.class.php 2.0 2012-12-30 01:28:54Z tommy <streen003@gmail.com> $
 * @package library
 * @since 1.0
 */
...
class Calendar {
    ...
    public function output() {
        ...
        //分析系统集成的日历视图路径
        $viewPath = DOIT_ROOT . 'views' . DIRECTORY_SEPARATOR . 'html' . DIRECTORY_SEPARATOR . 'calender.php';
