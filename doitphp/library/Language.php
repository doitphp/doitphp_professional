 ...
 * @version $Id: Language.php 2.0 2012-12-22 19:41:54Z tommy <streen003@gmail.com> $
 * @package core
 * @since 1.0
 */
...
class Language {
    ...
    public function __construct() {
        ...
        $this->_langPath = BASE_PATH . DS . ((!$moduleName) ? 'language': 'modules' . DS . $moduleName . DS . 'language') . DS;
