 ...
 * @version $Id: HtmlBuilder.php 2.0 2012-12-23 19:07:01Z tommy $
 * @package library
 * @since 1.0
 */
...
class HtmlBuilder {
    ...
    public function __construct() {
        ...
        $this->_htmlPath     = CACHE_PATH . DS . 'htmls' . DS;
        $this->_isWrite      = false;
    ...
    protected function _getFilePath($fileName = null) {
        ...
        return $this->_htmlPath . (!$moduleName ? '' : $moduleName . DS) . Doit::getControllerName() . DS . $fileName . '.html';
    }
