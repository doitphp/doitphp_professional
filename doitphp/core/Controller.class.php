 ...
 * @version $Id: Controller.class.php 2.0 2012-12-01 23:12:30Z tommy <streen003@gmail.com> $
 * @package core
 * @since 1.0
 */
...
abstract class Controller {
     ...
     * @return void
     */
    public static function import($fileName, $supportModule = true) {
        ...
        if ($supportModule) {
            ...
            if ($moduleName) {
                $modulePath = BASE_PATH . 'modules' . DIRECTORY_SEPARATOR . $moduleName . DIRECTORY_SEPARATOR;
        ...
        if (strpos($fileName, '/') !== false) {
            ...
            if (!$supportModule) {
                //分析获取文件的路径
                $filePath = realpath(BASE_PATH . 'library' . DIRECTORY_SEPARATOR . $fileName);
            } else {
                //分析获取文件的路径
                $filePath   = (!$moduleName) ? realpath(BASE_PATH . 'library' . DIRECTORY_SEPARATOR . $fileName) : realpath($modulePath . $fileName);
            }
        }
