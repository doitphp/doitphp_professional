 ...
 * @version $Id: Extension.class.php 2.0 2012-12-19 23:29:01Z tommy <streen003@gmail.com> $
 * @package core
 * @since 1.0
 */
...
abstract class Extension {
    ...
    protected static function _getExtRoot($extensionName) {
        ...
        return BASE_PATH . 'extensions' . DIRECTORY_SEPARATOR . strtolower($extensionName) . DIRECTORY_SEPARATOR;
    }
    ...
    public function getExtRoot() {
        ...
        return BASE_PATH . 'extensions' . DIRECTORY_SEPARATOR . $this->getExtName() . DIRECTORY_SEPARATOR;
    }
