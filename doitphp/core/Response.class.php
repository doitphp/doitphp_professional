 ...
 * @version $Id: Response.class.php 2.0 2012-11-28 00:50:27Z tommy <streen003@gmail.com> $
 * @package core
 * @since 1.0
 */
...
abstract class Response {
    ...
    public static function showMsg($message, $gotoUrl = null, $limitTime = 5) {
        ...
        $messageTemplateFile = BASE_PATH . 'views/error/message.php';
     ...
     * @return string
     */
    public static function ajax($status, $info = null, $data = array()) {

        $result             = array();
        $result['status']   = $status;
        $result['msg']      = !is_null($info) ? $info : '';
        $result['data']     = $data;
